...
def _glue_convert_examples_to_features(
    ...
    for i in range(len(examples)):
        ...
        # here insert segment-ids

        input_ids =
        token_type_ids =
        feature = InputFeatures(input_ids=input_ids, token_type_ids=token_type_ids, label=labels[i])
        features.append(feature)
...
class TnewsAugProcessor(DataProcessor):
    """Processor for the TNEWS data set (CLUE version)."""
